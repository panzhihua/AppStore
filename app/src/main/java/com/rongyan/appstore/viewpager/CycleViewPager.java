...
public class CycleViewPager extends Fragment implements OnPageChangeListener {
	...
	private List<BannersItem.Data.Banners> infos;
	...
	public void setData(List<ImageView> views, List<BannersItem.Data.Banners> list, ImageCycleViewListener listener,Context context) {
	 ...
	 */
	public void setData(List<ImageView> views, List<BannersItem.Data.Banners> list, ImageCycleViewListener listener, int showPosition) {
		...
		//viewPager.setOffscreenPageLimit(indicators.length);//预加载
	...
	public void setIndicatorCenter() {
		...
		params.setMargins(0,0,0, DensityUtils.px2dip(getActivity(),16));
	...
	public interface ImageCycleViewListener {
		 ...
		 * 单击图片事件
		 */
		void onImageClick(BannersItem.Data.Banners info, int postion, View imageView);
	}
}