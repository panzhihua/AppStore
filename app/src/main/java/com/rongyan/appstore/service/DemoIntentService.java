...
import com.rongyan.appstore.utils.ApksTaskUtils;
...
public class DemoIntentService extends GTIntentService {
    ...
    public void onReceiveMessageData(Context context, GTTransmitMessage msg) {
        ...
        if (payload == null) {
            ...
            // 测试消息为了观察数据变化
            if (data!=null&&data.equals(getResources().getString(R.string.push_transmission_data))) {
                data = data + "-" + cnt;
                cnt++;
            }
            sendMessage(data, 0);
            ...
            try {
                ...
                if (item != null) {
                    new ApksTaskUtils(getApplicationContext(),item);
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
